...
RELOAD_ALARM_CHANNEL = get_optional("RELOAD_ALARM_CHANNEL") or "SYSTEM"
RELOAD_ALARM_DEVICE = get_optional("RELOAD_ALARM_DEVICE") or "OpcTagManager"
RELOAD_ALARM_GROUP_PATH = tuple(
    part.strip() for part in get_optional("RELOAD_ALARM_GROUP_PATH").split("/") if part.strip()
)
RELOAD_ALARM_DRIVER = get_optional("RELOAD_ALARM_DRIVER") or "Memory Based"
RELOAD_ALARM_DEVICE_MODEL = get_int_default("RELOAD_ALARM_DEVICE_MODEL", 0)
RELOAD_ALARM_DEVICE_ID_FORMAT = get_int_default("RELOAD_ALARM_DEVICE_ID_FORMAT", 1)
RELOAD_ALARM_DEVICE_ID = get_optional("RELOAD_ALARM_DEVICE_ID") or "1"
RELOAD_ALARM_ADDRESS = get_optional("RELOAD_ALARM_ADDRESS") or "D0000"
RELOAD_ALARM_DATA_TYPE = get_int_default("RELOAD_ALARM_DATA_TYPE", 6)
RELOAD_ALARM_READ_WRITE_ACCESS = get_int_default("RELOAD_ALARM_READ_WRITE_ACCESS", 1)
RELOAD_ALARM_SCAN_RATE_MS = get_int_default("RELOAD_ALARM_SCAN_RATE_MS", 1000)
RELOAD_ALARM_BOOTSTRAP_ENABLED = get_bool_default("RELOAD_ALARM_BOOTSTRAP_ENABLED", False)
RELOAD_ALARM_REPAIR_ENABLED = get_bool_default("RELOAD_ALARM_REPAIR_ENABLED", False)
RELOAD_ALARM_SELF_HEAL_ENABLED = get_bool_default("RELOAD_ALARM_SELF_HEAL_ENABLED", False)
RELOAD_ALARM_HISTORIAN_ENABLED = get_bool_default("RELOAD_ALARM_HISTORIAN_ENABLED", False)
...
OPC_RUNTIME_RECONCILE_ON_STARTUP = get_bool_default("OPC_RUNTIME_RECONCILE_ON_STARTUP", True)
OPC_RUNTIME_RECONCILE_INTERVAL_SEC = get_int_default("OPC_RUNTIME_RECONCILE_INTERVAL_SEC", 900)
if OPC_RUNTIME_RECONCILE_INTERVAL_SEC < 0:
    raise RuntimeError("Configuration OPC_RUNTIME_RECONCILE_INTERVAL_SEC cannot be negative")
